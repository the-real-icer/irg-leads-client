                ...
                {reminders.length > 0 ? (
                    ...
                    >
                        {reminders.map((reminder) => {
                            ...
                            const daysUntil = Math.ceil(
                                (currentReminderDate - now) / (1000 * 60 * 60 * 24),
                            );
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        borderLeft: `4px solid ${
                                            isOverdue ? 'hsl(var(--danger))' : 'hsl(var(--warning))'
                                        }`,
                                        borderRadius: '8px',
                                ...
                                >
                                    ...
                                    >
                                        <div style={{ flex: 1 }}>
                                            ...
                                            >
                                                Due:{' '}
                                                {currentReminderDate.toLocaleDateString('en-US', {
                                                    weekday: 'short',
                                                    month: 'short',
                                                    day: 'numeric',
                                                    year: 'numeric',
                    ...
                    >
                        ...
                        <p style={{ fontSize: '0.9rem' }}>
                            Click "Add A Reminder" to set up a follow-up
                        </p>
                    </div>
                )}
            </div>
