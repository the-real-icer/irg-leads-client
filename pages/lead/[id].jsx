...
import EmailEngagementCard from '../../components/lead/EmailEngagementCard';
import LeadCoBuyersCard from '../../components/lead/LeadCoBuyersCard';
import LeadDripCampaignsCard from '../../components/lead/LeadDripCampaignsCard';
        ...
        <MainLayout title={pageTitle}>
            <div className="lead-profile-page">
                ...
                <LeadRemindersCard
                    ...
                    onAddReminderClick={() => setShowAddReminderDialog(true)}
                    onCompleteReminder={handleCompleteReminder}
                    onDeleteReminder={handleDeleteReminder}
                />

                {/* Drip Campaigns Section */}
                <LeadDripCampaignsCard
                    lead={lead}
                    onEnrollClick={() => {
                        fetchAvailableCampaigns();
                        setShowEnrollDripDialog(true);
                    }}
                    onUnenroll={handleUnenrollFromCampaign}
                    getDripCampaignProgress={getDripCampaignProgress}
                    getLastSentDate={getLastSentDate}
                    getLastOpenedDate={getLastOpenedDate}
                    getDripTypeBadgeColor={getDripTypeBadgeColor}
                />
                ...
                <EmailEngagementCard
                    engagement={lead?.email_engagement}
                    emailEvents={emailEvents}
                    loadingEmailEvents={loadingEmailEvents}
                />
